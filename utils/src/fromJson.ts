...
//   const decreaseList = json.decreaseList.map(positionDecreaseJson).sort((a, b) => a.blockTimestamp - b.blockTimestamp)
//   const increaseList = json.increaseList.map(positionIncreaseJson).sort((a, b) => a.blockTimestamp - b.blockTimestamp)
//   const updateList = json.updateList.map(positionUpdateJson).sort((a, b) => a.blockTimestamp - b.blockTimestamp)
